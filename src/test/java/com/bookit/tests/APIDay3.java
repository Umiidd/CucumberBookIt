...
public class APIDay3 {
  ...
  public void regionPOSTv1() {
	  ...
	  String requestBody = "{\"region_id\":35,\"region_name\":\"myregion\"}";
	  ...
	  //verify region id
	  assertEquals(json.getInt("region_id"), 35);
  ...
  public void regionPOSTv2() {
	  ...
	  //verify region id
	  assertEquals(json.getInt("region_id"), 234);
  ...
  public void regionPOSTv3() {
	  ...
	  //verify region id
	  assertEquals(json.getInt("region_id"), 131);
